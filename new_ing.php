...
session_start();
if(isset($_GET['id'])){
$user = $conn->query("SELECT * FROM categories_inventory where id =".$_GET['id']);
...
<div class="container-fluid">
	...
	<form action="" id="new_ingredients">	
...
<script>
	...
	$('#new_ingredients').on('reset',function(){
		$('input:hidden').val('')
		$('.select2').val('').trigger('change')
	})
	
	$('#new_ingredients').submit(function (e) {
    e.preventDefault();
